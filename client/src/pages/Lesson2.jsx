...
export default function Lesson2() {
  ...
  const handleNextLevel = () => {
    const passed = score >= getLevelData().passingScore;
          ...
          {gameState === 'outcome' && outcome && (
            <div className="space-y-6">
              ...
              <div className="p-6 bg-indigo-500/10 border border-indigo-500/30 rounded-xl">
                <h4 className="text-lg font-semibold text-indigo-400 mb-2">💡 Learning Point</h4>
                <p className="text-slate-200 leading-relaxed">{outcome.feedback}</p>
              </div>
